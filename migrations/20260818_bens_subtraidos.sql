...
alter table public.ocorrencias
  add column if not exists bens_subtraidos jsonb not null default '[]'::jsonb;

alter table public.ocorrencias drop constraint if exists ocorrencias_bens_subtraidos_array;
alter table public.ocorrencias add constraint ocorrencias_bens_subtraidos_array check (jsonb_typeof(bens_subtraidos) = 'array');
...
begin
  ...
  update public.ocorrencias set
    ...
    bens_subtraidos=coalesce(v.bens_subtraidos,'[]'::jsonb),
